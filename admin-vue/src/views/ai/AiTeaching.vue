  ...
  <div class="ai-page">
    <div class="page-header">
      <div class="header-left">
        <h2><el-icon><TrendCharts /></el-icon> 教学质量评估</h2>
        <span class="header-subtitle">基于AI的教学质量智能评估分析</span>
      </div>
    </div>
    ...
    <el-card shadow="never" class="report-card" style="margin-top: 20px" v-loading="loading">
      <template #header>
        <div class="card-header">
          <span class="card-title"><el-icon><Cpu /></el-icon> AI 教学质量评估报告</span>
...
import { getTeachingQuality, chatStream } from '@/api/ai'
...
const fetchData = async () => {
  loading.value = true
  try {
    const res = await getTeachingQuality(queryForm)
