  ...
  <div class="page-container">
    ...
    <el-card shadow="never">
      <el-form :inline="true" :model="queryForm">
        <el-form-item label="教学楼">
          <el-input v-model="queryForm.building" placeholder="请输入教学楼" clearable />
        </el-form-item>
        <el-form-item label="教室名称">
          <el-input v-model="queryForm.roomNumber" placeholder="请输入教室名称" clearable />
        </el-form-item>
    ...
    <el-card shadow="never" style="margin-top: 16px">
      <el-table :data="tableData" v-loading="loading" stripe border>
        ...
        <el-table-column prop="roomNumber" label="教室名称" min-width="150" />
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="560px" destroy-on-close>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="教室名称" prop="roomNumber">
          <el-input v-model="form.roomNumber" placeholder="请输入教室名称" />
        </el-form-item>
...
const form = reactive({ id: null, building: '', roomNumber: '', floor: 1, type: '普通教室', capacity: 60, status: '正常' })
const rules = {
  building: [{ required: true, message: '请输入教学楼', trigger: 'blur' }],
  roomNumber: [{ required: true, message: '请输入教室名称', trigger: 'blur' }],
...
const handleAdd = () => {
  ...
  Object.assign(form, { id: null, building: '', roomNumber: '', floor: 1, type: '普通教室', capacity: 60, status: '正常' })
  dialogVisible.value = true
}
const handleEdit = (row) => { isEdit.value = true; dialogTitle.value = '编辑教室'; Object.assign(form, { ...row }); dialogVisible.value = true }
